...
| C18 | **T10** — LIVE-scribe capture closes the chain (salient chatty facts, Haiku, 2 seeds): a live model doing its own capture loses nothing vs oracle capture and keeps the lead over summarization | capture 100% (60/60), 0 noise ops; end-to-end +26.7% vs summary; +6.7% vs mech-rope (parity) | 60 | [+13.3%, +40.0%] vs summary; [−5.0%, +18.3%] vs mech (parity) | `results/t10-scribe/result-cmd.json` | `JROPE_BENCH_BUDGET_USD=1 python research/exp_t10_scribe.py --scribe cmd --cmd "claude -p --model haiku"` |
